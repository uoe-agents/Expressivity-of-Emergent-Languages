...
def _populate_cl_params(arg_parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    arg_parser.add_argument('--language_save_freq', type=int, default=5,
                        help='How often the language are saved.')
    ...
    arg_parser.add_argument('--num_msg_log_path', type=str, default='log/num_msg_logs',
                        help="Path to log file for number of messages.")
    # cuda setup
    arg_parser.add_argument('--no_cuda', default=False, help='disable cuda', action='store_true')
    ...
    arg_parser.add_argument('--hidden_size', type=int, default=256,
                        help='Hidden size of all encoders/decoders.')
    ...
    arg_parser.add_argument('--max_len', type=int, default=4,
                        help='Max length of the sequence (default: 4)')
    arg_parser.add_argument('--emb_size', type=int, default=256,
                        help='Embedding size of symbols in the channel (default: 256).')
    ...
    arg_parser.add_argument('--game_size', type=int, default=5,
                            help='Number of candidates (target+distractors) for listeners in referential games.')
    arg_parser.add_argument('--contrastive', default=False, action='store_true',
                            help='disable contrastive loss for referential game')
